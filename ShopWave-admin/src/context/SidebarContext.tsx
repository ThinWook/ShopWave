...
export const SidebarProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    ...
    // Listen for global toggle events (used by header/sidebar button)
    ...
    window.addEventListener('toggleMobileSidebar', onToggleMobile as EventListener);

    return () => {
      window.removeEventListener("resize", handleResize);
      window.removeEventListener('toggleSidebar', onToggleSidebar as EventListener);
      window.removeEventListener('toggleMobileSidebar', onToggleMobile as EventListener);
    };
  }, []);
