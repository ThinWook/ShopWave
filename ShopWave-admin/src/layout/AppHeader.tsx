...
// NotificationDropdown removed per request
  ...
  <header className="sticky top-0 flex w-full bg-white border-gray-200 z-30 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-30 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border lg:hidden"
          ...
          <Link to="/" className="lg:hidden">
            <img
              ...
              alt="Logo"
            />
            <span className="hidden dark:block select-none font-semibold tracking-wide text-xl uppercase text-gray-900 dark:text-white transition-all duration-200 opacity-100">ShopWave</span>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <button
              className="inline-flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg dark:border-gray-800 dark:text-gray-400 h-11 w-11 border"
              onClick={handleToggle}
              aria-label="Toggle Sidebar"
            >
