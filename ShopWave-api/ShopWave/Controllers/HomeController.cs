    ...
    public class HomeController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<object>>> GetDashboard()
        {
            try
            {
                ...
                return Ok(ApiResponse<object>.SuccessResult(stats, "L?y thông tin dashboard thành công"));
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "L?i khi l?y thông tin dashboard");
                return StatusCode(500, ApiResponse<object>.ErrorResult("Có l?i x?y ra khi l?y thông tin dashboard"));
            }
        }
